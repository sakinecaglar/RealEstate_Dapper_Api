...
using RealEstate1_Dapper_UI.Dtos;
using RealEstate1_Dapper_UI.Dtos.TestimonialDtos;
...
namespace RealEstate1_Dapper_UI.ViewComponents.HomePage
{
    public class _DefaultOurTestimonialComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44379/api/Testimonials");
